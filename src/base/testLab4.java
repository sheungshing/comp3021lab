...
public class testLab4 {
	public static void main(String args[]) throws Exception{
		...
		//System.out.println( new File(((TextNote) nb2.getFolders().get(0).getNotes().get(0)).getTitle().replaceAll(" ", "_")+".txt").exists()  );
		if(new File(((TextNote) nb2.getFolders().get(0).getNotes().get(0)).getTitle().replaceAll(" ", "_")+".txt").exists()){
			...
			throw new Exception("Your code has some problems....... task3");
		}
