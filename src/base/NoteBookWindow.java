...
public class NoteBookWindow extends Application {
	...
	private HBox addHBox() {
		...
		hbox.getChildren().addAll(buttonLoad, buttonSave,label,textSearch, searchButton, clearButton);
		return hbox;
	}
	...
	private VBox addVBox() {
		...
		foldersComboBox.getItems().addAll(folderNameList);
		...
		titleslistView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Object>() {
			...
			public void changed(ObservableValue ov, Object t, Object t1) {
				...
				if(nowNote != null){
					if( nowNote instanceof TextNote){
						TextNote temp = (TextNote)nowNote;
	...
	private void updateListView() {
		...
		System.out.println("updateListView called!");
		...
		if(nowFolder != null){
			...
			if(currentSearch == ""){
				...
				searchNote =nowFolder.searchNotes(currentSearch);
				for(Note n:searchNote){
					list.add(n.getTitle());
				}
