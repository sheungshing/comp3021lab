...
public class FindMax {
	...
	class ThreadFindMax implements Runnable{
	...
	public void printMaxThread() {
		ThreadFindMax task1 = new ThreadFindMax(0, 29);
		Thread t1 = new Thread(task1);
		ThreadFindMax task2 = new ThreadFindMax(30, 59);
		Thread t2 = new Thread(task2);
		ThreadFindMax task3 = new ThreadFindMax(60, 89);
		...
		System.out.print("the max value is "+ Math.max( (Math.max(task1.getResult(), task2.getResult())), task3.getResult()));
